...
import { Search, Calendar, Check, X, Clock, RefreshCw } from "lucide-react";
...
function ReminderHistory({ selectedPatientId }) {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Filter schedules belonging to patient's medicines
      ...
      patientSchedules.sort(
        (a, b) => new Date(b.reminder_time) - new Date(a.reminder_time)
      );
    ...
    return (
      <div className="empty-state glass-card">
        ...
        <p style={{ marginTop: "8px" }}>
          Please select a patient profile from the header to view their compliance history.
        </p>
      </div>
    );
  }
